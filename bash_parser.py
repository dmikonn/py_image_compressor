...
def get_conv_parameters() -> tuple[str, float, int, int | None, int | None, bool]:
    ...
    parser.add_argument("-r", "--resize-ratio", type=float, help="Resizing ratio from 0 to 1, setting to 0.5 will multiply width & height of the image by 0.5. Default is 1.0", default=0.9)
    ...
    return(args.image, args.resize_ratio, args.quality, args.width, args.height, args.to_jpg)